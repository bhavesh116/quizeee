        ...
        <Wrapper>
          ...
          { Object.values(quizData).length > 0 &&
            ...
            <div>Instagram Bio</div>
              ...
              <LinkDiv><div>{`https://quizee.netlify.app/quiz/${quizId}`}</div><IcomImg onClick={() => copyToClip(`https://quizee.netlify.app/quiz/${quizId}`)} src="https://i.ibb.co/Z2Vwmy8/copy.png"/></LinkDiv>
